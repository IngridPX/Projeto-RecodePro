...
Insert into produtos()values(default,'Bolo de Aipim Cremoso','Bolos Caseiros','20.00','17.00','https://apucarana.cidadecancao.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/b/o/bolo_aipim_cremoso_kg_86042.jpg_1.jpg'
),
...
(default,'Pão de Ló com Nozes','Bolos de Festa','150.00','127.50','imagens/bolo.jpg'
),
...
(default,'Bolo de Paçoca','Bolos de Pote','5.00','3.40','imagens/bolo de pote-pacoca.jpg'
),
(default,'Bolo de Mousse de Limão','Bolos de Pote','5.00','3.40','imagens/limao.png'
),
...
(default,'Cheesecake de Paçoca','Cheesecakes sem Forno','40.00','34.00','imagens/Cheesecake.png'
),
